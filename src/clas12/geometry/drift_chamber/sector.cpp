 ...
 **/
Sector::Sector(const DriftChamber* drift_chamber, const size_t& idx)
: _drift_chamber(drift_chamber)
, _idx(idx)
{
}
 ...
 *             held by parent DriftChamber.
 **/
Sector::Sector(const Sector& that, const DriftChamber* drift_chamber, const size_t& idx)
: _drift_chamber(drift_chamber)
, _idx(idx)
{
